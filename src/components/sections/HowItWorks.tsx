...
const steps = [
  ...
  },
  {
    ...
    label: "Step 2",
    title: "Schedule once, post forever",
    description: "Use AI to draft, your calendar to schedule, and LinkedInFlow to handle the rest. Batch a whole month in one sitting.",
  },
  {
